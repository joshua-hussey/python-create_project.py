...
git add paycheck.py
git commit -m "Add name and date to paycheck.py header"
git push
...
git add paycheck.py
git commit -m "Implement calculations in paycheck.py"
git push
...
git add paycheck.py
git commit -m "Fix formatting and output for paycheck calculations"
git push
